...
public enum SwiftHelpCenterL10n {
    ...
    public static let feedbackContact = "FeedbackView.contact"
    public static let feedbackContactPlaceholder = "FeedbackView.contactPlaceholder"
    ...
    public static let feedbackManagerContact = "FeedbackManager.contact"
